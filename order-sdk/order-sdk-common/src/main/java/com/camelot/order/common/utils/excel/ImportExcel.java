		...
		for (int i = this.getDataRowNum(); i < this.getLastDataRowNum(); i++) {
			...
			for (Object[] os : annotationList){
				...
				if (val != null){
					...
					try {
						if (ef.fieldType().getName().contains(this.getClass().getPackage().getName())) {
						...
						//	val = com.camelot.mdm.common.utils.StringUtils.transformation(val);
