...
/**
 * <p>Description: [redisTemplate 事务出来工具类]</p>
 * @ClassName RedisTxUtil
 * Created on 2018/12/6.
 *
 * @author <a href="mailto: sunxianwei@camelotchina.com">sunxiaozhe</a>
...
public class RedisTxUtil implements ApplicationContextAware {

    private static ApplicationContext applicationContextTx = null;

    private static RedisTemplate<String, Object> redisTemplateTx;
    ...
    public static RedisTemplate<String, Object> getRedisTemplate(){
        if (redisTemplateTx == null){
            synchronized (RedisTemplate.class){
                if (redisTemplateTx == null){
                    Object obj = applicationContextTx.getBean("redisTemplateTx");
                    redisTemplateTx = (RedisTemplate<String, Object>) obj;
                }
            }
        }
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        if (RedisTxUtil.applicationContextTx == null){
            RedisTxUtil.applicationContextTx = applicationContext;
        }
    }
