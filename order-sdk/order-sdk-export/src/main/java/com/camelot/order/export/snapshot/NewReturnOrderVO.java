...
public class NewReturnOrderVO extends BaseVO implements Serializable {
	...
	/**退货商品*/
	private List<NewReturnOrderGoodsVO> newReturnOrderGoodsList;
	/**退货订单id集合*/
	...
	public List<NewReturnOrderGoodsVO> getNewReturnOrderGoodsList() {
		return newReturnOrderGoodsList;
	}

	public void setNewReturnOrderGoodsList(List<NewReturnOrderGoodsVO> newReturnOrderGoodsList) {
		this.newReturnOrderGoodsList = newReturnOrderGoodsList;
	}
