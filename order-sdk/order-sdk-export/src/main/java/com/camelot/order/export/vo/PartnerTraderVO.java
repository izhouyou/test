...
public class PartnerTraderVO implements Serializable{
	...
	public String toString() {
		return "PartnerTraderVO [partnerNumber=" + partnerNumber + ", partnerSimpleName=" + partnerSimpleName
				+ ", partnerName=" + partnerName + ", partnerType=" + partnerType + ", mobilePhone=" + mobilePhone
				+ ", companyName=" + companyName + ", partnerTraderVO=" + partnerTraderVO + "]";
	}
